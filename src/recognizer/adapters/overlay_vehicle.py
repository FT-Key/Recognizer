"""Overlay del contador de vehiculos: cajas con ID, linea de conteo y HUD."""
...
HUD_SCALE = 0.9
HUD_THICKNESS = 2
HUD_COLOR_BGR = (0, 165, 255)
HUD_CURRENT_POSITION = (10, 30)
HUD_COUNTS_POSITION = (10, 60)
HUD_CURRENT_TEMPLATE = "Vehiculos: {current}"
