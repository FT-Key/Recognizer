...
def test_create_analysis_limits_modules_to_detection_and_recognition(
    ...
    mod._create_analysis(model_path="models/buffalo_s")
...
def test_split_model_path_uses_parent_or_models() -> None:
    assert mod._split_model_path("models/buffalo_s") == ("models", "buffalo_s")
    assert mod._split_model_path("buffalo_s") == ("models", "buffalo_s")
